...
func main() {
	...
	for times := 1; times <= maxRun; times++ {
		probabilityArray[0] = 1474
		probabilityArray[1] = 2560
		probabilityArray[2] = 239
		probabilityArray[3] = 967
		probabilityArray[4] = 2043
		probabilityArray[5] = 473
		probabilityArray[6] = 303
		probabilityArray[7] = 1391
		probabilityArray[8] = 67
		probabilityArray[9] = 482
		...
		fmt.Println("times: ", times, " => ", rankingArray)
	...
	fmt.Println("statistics Case 22: ", (float32(statistics22Count) / float32(maxRun)))
	fmt.Println("statistics Case 23: ", (float32(statistics23Count) / float32(maxRun)))
	fmt.Println("statistics Case 24: ", (float32(statistics24Count) / float32(maxRun)))
	fmt.Println("statistics Case 25: ", (float32(statistics25Count) / float32(maxRun)))
	fmt.Println("statistics Case 26: ", (float32(statistics26Count) / float32(maxRun)))
	fmt.Println("statistics Case 27: ", (float32(statistics27Count) / float32(maxRun)))
	fmt.Println("statistics Case 28: ", (float32(statistics28Count) / float32(maxRun)))
	fmt.Println("statistics Case 29: ", (float32(statistics29Count) / float32(maxRun)))
	fmt.Println("statistics Case 30: ", (float32(statistics30Count) / float32(maxRun)))
	fmt.Println("statistics Case 31: ", (float32(statistics31Count) / float32(maxRun)))
	fmt.Println("statistics Case 32: ", (float32(statistics32Count) / float32(maxRun)))
	fmt.Println("statistics Case 33: ", (float32(statistics33Count) / float32(maxRun)))
	fmt.Println("statistics Case 34: ", (float32(statistics34Count) / float32(maxRun)))
	fmt.Println("statistics Case 35: ", (float32(statistics35Count) / float32(maxRun)))
	fmt.Println("statistics Case 36: ", (float32(statistics36Count) / float32(maxRun)))
	fmt.Println("statistics Case 37: ", (float32(statistics37Count) / float32(maxRun)))
	fmt.Println("statistics Case 38: ", (float32(statistics38Count) / float32(maxRun)))
	fmt.Println("statistics Case 39: ", (float32(statistics39Count) / float32(maxRun)))
	fmt.Println("statistics Case 40: ", (float32(statistics40Count) / float32(maxRun)))
	fmt.Println("statistics Case 41: ", (float32(statistics41Count) / float32(maxRun)))
	fmt.Println("statistics Case 42: ", (float32(statistics42Count) / float32(maxRun)))
	fmt.Println("statistics Case 43: ", (float32(statistics43Count) / float32(maxRun)))
	fmt.Println("statistics Case 44: ", (float32(statistics44Count) / float32(maxRun)))
	fmt.Println("statistics Case 45: ", (float32(statistics45Count) / float32(maxRun)))
